...
This tree is the packages repo. It has no apps. Canonical remote: [a6n-ai/foundry](https://github.com/a6n-ai/foundry). The copy inside Realm **stays** until [EXTRACTION.md](../EXTRACTION.md) phase 4 — do not delete it. Leaf packages install from git; floor packages stay `workspace:*`.
