...
// Copied from tiffin-grab's lib/http/api-fetch rather than imported: the package
// must not reach into an app. Nothing here is app-specific — it is RFC 9457
// problem+json plus a Sonner toast.
//
