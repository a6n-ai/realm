...
Canonical remote: [a6n-ai/relay](https://github.com/a6n-ai/relay). Other products (Realm, Monarch, Copper+Cloves) are tenants with API keys — they do not share Relay users. Realm installs `@relay/*` from git. The copy inside Realm **stays** until [EXTRACTION.md](../EXTRACTION.md) delete — do not delete it.
