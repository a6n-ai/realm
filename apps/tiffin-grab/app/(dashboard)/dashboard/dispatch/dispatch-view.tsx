...
import { pushDeliveryAction, removeDeliveryAction, reassignDriverAction } from "./actions";
        ...
        <>
          ...
          <TableCell>
            <div className="flex justify-end gap-2">
              <Button size="sm" variant="outline" disabled={pending} onClick={() => push(r.orderNo)}>
                Push
              </Button>
              <Button
                size="sm"
      ...
      mobileCard={(r) => (
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Button size="sm" variant="outline" className="flex-1" disabled={pending} onClick={() => push(r.orderNo)}>
              Push
            </Button>
            <Button
              size="sm"
