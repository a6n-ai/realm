...
// MealDayPicker, plus the per-day Skip/Change-address controls below it. Never renders
// pause/resume — that's a separate control (pause-calendar.tsx), decoupled from day-click on
// purpose.
//
...
//   - "cell":       myCalendar resolved a released-week cell for this date — the normal case.
