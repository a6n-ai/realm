...
export default async function LandingPage() {
  ...
  return (
    <>
      ...
      <Section>
        <p className="m-0 mb-1 text-xs font-semibold tracking-[0.25em] text-primary uppercase">03 — The dabba math</p>
        ...
        <Button asChild size="lg" className="mt-8.5 rounded-full"><Link href="/subscribe">See my price →</Link></Button>
      </Section>
