...
const FAQS = [
  ...
  { q: "Can I customize my meals?", a: "Yes. You choose a nutrition baseline, meal size, and commitment length — then pick the dishes for each delivery." },
  { q: "How does pricing work?", a: "You pay a per-tiffin rate multiplied by your total tiffin count (delivery days per week × weeks). The per-tiffin rate drops with volume — orders of 20 or more tiffins get the best rate with no small-order surcharge. See the Pricing page." },
