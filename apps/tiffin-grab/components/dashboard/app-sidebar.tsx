...
export const SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: "Routes", href: "/dashboard/routes", icon: MapPinnedIcon, roles: ["admin", "member"] },
  ...
  },
  {
    ...
    items: [
      { title: "Organization", href: "/dashboard/organization/clients", icon: Building2Icon, roles: ["admin"] },
