...
const dish = { planTags: [], name: "Paneer Butter Masala", description: "Creamy tomato gravy", image: { name: "p.jpg", url: "/api/files/p.jpg", filePath: "p", fileName: "p", type: "image/jpeg", isDirectory: false, size: 1 } };
