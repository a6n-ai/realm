          ...
          <Form {...codeForm}>
            <form onSubmit={codeForm.handleSubmit(verifyCode)} className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">We emailed a 6-digit code to {email}.</p>
              </div>
              <FormField
              ...
              <Button type="button" variant="ghost" className="w-full" onClick={() => setState("revealed")}>
