...
export function SubscribeChrome({
  ...
  return (
    <div className="bg-background/95 sticky top-0 z-30 -mx-4 mb-4 flex items-center justify-between border-b-[1.5px] border-foreground px-4 py-2.5 backdrop-blur sm:-mx-0 sm:px-0">
      <Button
        type="button"
        variant="ghost"
        size="sm"
