...
const snapshot: CatalogSnapshot = {
  plans: [],
  mealSizes: [
    { id: BigInt(1), publicId: "msz_1", key: "k", name: "K", description: null, planId: BigInt(1), planKey: "veg", tier: "budget", components: [], items: [], swapRules: [], kcalMin: 1, kcalMax: 2, proteinG: null, carbsG: null, fatG: null, basePrice: 10, discountType: "none", discountValue: 0, trial: false },
  ],
