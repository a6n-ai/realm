...
import { assertHierarchyDepth } from "@foundry/auth";
...
// Falls back to the seeded system user (same pattern as inquiries.service.ts's
// sys-user lookup) when there's no request-scoped session, e.g. a script or test.
