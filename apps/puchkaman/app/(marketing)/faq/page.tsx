...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: "Do you deliver across the GTA?",
    a: "We deliver ourselves within 7km of our Scarborough location — instantly at 15% off, or on a scheduled time slot beyond 7km with a $35 order minimum. For the rest of the GTA, find us on Uber Eats and DoorDash.",
  },
  {
