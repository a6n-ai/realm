        ...
        <div className="wrap" style={{ padding: "40px 20px 80px" }}>
                  ...
                  >
                        ...
                        {item.tags.map((t) => (
                          <span
                            ...
                            style={{
                              ...
                              boxShadow: "2px 2px 0 var(--ink)",
                              background:
                                t === "viral" ? "var(--red)" : t === "new" ? "var(--mint)" : "var(--yellow)",
                    ...
                    <div style={{ padding: "14px 15px 16px", flex: 1, display: "flex", flexDirection: "column" }}>
                      ...
                      >
                        ...
                        <span className="display" style={{ fontSize: "1.12rem", color: "var(--red)", flexShrink: 0 }}>
          ...
          >
            ...
            <div className="flex wrap-gap" style={{ justifyContent: "center" }}>
              <Btn page="cart" variant="red" size="lg">
                View cart →
              </Btn>
