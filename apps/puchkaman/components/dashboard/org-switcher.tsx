...
// Header switcher for staff who hold member rows in more than one org — e.g.
// someone covering both Vancouver and Toronto. Hidden entirely below 2 orgs:
// nothing to switch between for the common single-location case.
