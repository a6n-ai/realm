...
import type { PlaceSuggestion } from "@foundry/places/types";
...
export function AddressAutocomplete({
  ...
  function pick(suggestion: PlaceSuggestion) {
    ...
    setOpen(false);
    setActiveIndex(-1);
    // No client-side resolve() call here — no caller may trust a lat/lng that
    // came back to the browser; whatever persists coordinates (checkout,
    // store-origin) re-resolves this same placeId/address server-side itself.
  }
