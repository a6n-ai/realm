...
// Trust ONLY x-real-ip — the same header this app's own edge/proxy setup
// would need to trust for rate limiting; x-forwarded-for is spoofable by a
// client prepending their own value ahead of the real one.
