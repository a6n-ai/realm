...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@realm/notifications", "@realm/commons", "@realm/database", "@realm/routes", "@realm/themes", "@realm/ui", "@realm/design-system", "@realm/crm", "@realm/realtime", "@realm/auth-ui", "@realm/clover", "@realm/google-reviews", "@realm/order-tracking"],
