...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@relay/whatsapp", "@relay/sms", "@relay/engine", "@relay/email", "@foundry/commons", "@foundry/database", "@foundry/routes", "@foundry/themes", "@foundry/ui", "@foundry/design-system", "@foundry/delivery", "@foundry/address", "@foundry/crm", "@foundry/realtime", "@foundry/email", "@foundry/auth", "@foundry/auth-ui", "@foundry/clover", "@foundry/coupons", "@foundry/doordash", "@foundry/google-reviews", "@foundry/order-tracking", "@foundry/places", "@foundry/storage", "@foundry/uber-eats", "@foundry/wallet"],
